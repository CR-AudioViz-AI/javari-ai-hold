...
export default function LoginPage() {
  ...
  async function handleOAuth(provider: 'google' | 'github') {
    ...
    const { error } = await supabase.auth.signInWithOAuth({
      provider,
      options: {
        redirectTo: `${APP_URL}/auth/callback?redirect_to=/javari`,
    ...
    <main className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Sign in to Javari AI</h1>
        ...
        <p className="text-center text-xs text-slate-600 mt-6">
          ...
          <a href="https://craudiovizai.com/legal/terms" className="underline hover:text-slate-400">Terms</a>
          {' '}and{' '}
          <a href="https://craudiovizai.com/legal/privacy" className="underline hover:text-slate-400">Privacy Policy</a>.
        </p>
      </div>
    </main>
  )
