-- JAVARI OS INGESTION RPC FUNCTIONS
-- Direct SQL execution bypassing PostgREST RLS cache
-- 2026-02-27 - Stage 3 SQL Ingestion Engine
...
-- ═══════════════════════════════════════════════════════════════
GRANT EXECUTE ON FUNCTION insert_canonical_document TO service_role;
GRANT EXECUTE ON FUNCTION insert_canonical_chunk TO service_role;
GRANT EXECUTE ON FUNCTION insert_canonical_vector TO service_role;
GRANT EXECUTE ON FUNCTION insert_memory_node TO service_role;
GRANT EXECUTE ON FUNCTION insert_memory_edge TO service_role;
